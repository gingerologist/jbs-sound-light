...
Mozart是整个项目开发过程中的工具软件的code name。

| 功能集编号 | 说明                                                         | 状态   |
| ---------- | ------------------------------------------------------------ | ------ |
| 1          | 访问usb串口的C3/minimo，调用所有指令，收取消息               | 未开始 |
| 2          | 可侦听周围未组网的灯泡广播生成组网文件或使用预定义组网文件组网<br />在组网文件内编辑和包含灯效<br />向网络发送灯效观看效果<br />实现unibeacon协议所需的通讯协议<br />不包含固件升级，所有灯的固件预先线刷 | 未开始 |
| 3          | 增加ota功能，从Mozart下发新固件版本至组内所有灯泡            | 未开始 |
| 4          | 模仿云服务协议向Gateway/Speaker下发configuration和音效灯效指令，模拟下载mp3文件 | 未开始 |
| 5          | 支持完成组装业务                                             | 未开始 |
